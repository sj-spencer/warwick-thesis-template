...
\section{By the end of this chapter you should know}
\subsection{Why I use $kld$ so much}
\subsection{Fluid vs kinetic SRS}
\subsection{Why focus on bSRS}
\subsection{Rosenbluth gain}
\subsection{What is Rose's Loss of resonance?}

\section{Linear theory}
This section concerns the linear theory of plasma waves in a non-magnetised hot plasma.
