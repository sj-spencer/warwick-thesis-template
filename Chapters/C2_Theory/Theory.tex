...
\end{equation} We then subsititue this into Equation \ref{eqn:rosenbluth_solveable_EMW} and set the source for $\tilde{a_1}(0,0) = I\delta(x-x_0)/p$ to get the following PDE describing $\tilde{a_1}$ in terms of $x$:

\begin{equation}
	\left(p + \Gamma_1 + i\frac{\kappa}{2}v_1 + v_1\frac{\partial}{\partial x}\right)\tilde{a_1} = \frac{\gamma_0^2}{\Gamma_2 - i v_2 \kappa/2}\tilde{a}_1 + I\delta(x-x_0)/p
\end{equation}
