...
\label{eqn:EOS}
\end{equation} with $\gamma = C_p/C_v = 1 + 2/n = 3$ in one dimension. \todo{ask Tony if you can get an expression for un-linearised P = f(T,n)} When taken together, Equations \ref{eqn:continuity}, \ref{eqn:momentum}, and \ref{eqn:EOS} are known as the hydrodynamic equations of motion.
