...
Figure \ref{fig:pumpdepletion} shows the Poynting flux of the scattered light (a) and incident laser (b) for a simulation with intensity in the saturated regime ($I_0 = 7.83\times10^{15} \si{W/\centi\metre^2}$). We can see complete depletion of the pump correlated with the maximum intensity of scattered light first at approximately $x=45\si{\micro\metre}$, $t=0.8\si{\pico\second}$
