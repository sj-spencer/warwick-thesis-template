...
Finally, the 2019 paper \citet{Zhao2019} finds that SRS can be well controlled for a laser
...
instability can grow to a high level if the beamlets satisfy this coupling
condition, even if the total bandwidth is very large. They derive a gain exponent for standard convective SRS driven by two
...
&&&\\[-1em]
351   & $3\times 10^{15}$  &  0, 1, 10 &  0, 0.12, 1.2 \\ \hline
&&&\\[-1em]
248   &    & 0, 3, 6  &     \\ \hline
&&&\\[-1em]
